  ...
  if (status === "unauthenticated") {
    return (
      <div className="p-6 text-center">
        ...
        <Link href="/api/auth/signin" className="bg-blue-500 text-white px-4 py-2 rounded">
          Sign In
        </Link>
      </div>
    );
    ...
    <div className="p-6">
      ...
      <div className="border-b mb-6">
        <div className="flex overflow-x-auto">
          ...
          <button
            className={`px-4 py-2 font-medium text-sm ${activeTab === "cancelled" ? "border-b-2 border-blue-500 text-blue-600" : "text-gray-500 hover:text-gray-700"}`}
              ...
              <div className="p-4">
                ...
                <div className="mb-3">
                  <p className="text-gray-700">
                    <span className="font-medium">Price:</span> Rs. {order.product.price.toLocaleString()}
                  </p>
                  <p className="text-gray-700">
                ...
                {order.customOptions && Object.keys(order.customOptions).length > 0 && (
                  <div className="mb-3">
